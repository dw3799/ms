...
function addHtml(dataSelect) {
    ...
    for (var i = 0; i < dataSelect.length; i++) {
        ...
        // totalCount = data.totalCount;
        table_html += '<tr><td>' + data.groupNo + '</td>' + '<td>' + data.groupName + '</td><td>' + data.leaderName + '</td>' + '<td><a class="follow" data-id="' + data.groupId + '" onclick="changeGroup(' + data.groupId + ')">修改</a></td></tr>';
    }
